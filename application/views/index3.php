          ...
          <!-- ./col -->
            ...
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text"><?php foreach($count as $nb){if(($nb->Total)>1){echo "Documents";}else{echo"Document";}}?></span>
                <span class="info-box-number"><?php foreach($count as $nb){echo htmlentities($nb->Total);} ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                  <tr>
				          <?php foreach($datafiles as $dat){ ?>
                    <td><?php echo htmlentities($dat->typ_contrat); ?></td>
                    <td><?php echo htmlentities($dat->co_contrat); ?></td>
                    <td><?php echo htmlentities($dat->lieu); ?></td>
                    <td><?php echo htmlentities($dat->date_echeance); ?></td>
                  </tr>
				          <?php } ?>
                </table>
              </div>
