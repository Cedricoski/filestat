    ...
    <div class="sidebar">
     ...
     <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="Numerises" class="nav-link active">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <!-- /.form group -->
                <div class="form-group">
                  <label>Auteur Numérisation</label>
                  <select class="select2bs4" name="author" data-placeholder="Selectionner l'auteur" style="width: 100%;">
                          <option value=""></option>
                  <?php if($author): ?>
                    <?php foreach ($author as $k): ?>
                    <option value="<?php echo htmlentities($k->author);?>"><?php echo htmlentities($k->author); ?></option>
                    <?php endforeach ?>
                    <?php endif; ?>
                  </select>
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Serveur</label>
                  <select class="select2bs4" name="hostname" data-placeholder="Selectionner l'hôte" style="width: 100%;">
                          <option value=""></option>
                  <?php if($hostname): ?>
                    <?php foreach ($hostname as $k): ?>
                    <option value="<?php echo htmlentities($k->hostname);?>"><?php echo htmlentities($k->hostname); ?></option>
                    <?php endforeach ?>
                    <?php endif; ?>
                  </select>
                </div>
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">TOTAL DOSSIERS</span>
                <?php if($nb): ?>
                    <?php foreach ($nb as $k): ?>
                ...
                <table id="example5" class="table table-bordered table-striped">
                  ...
                  <?php if($req): ?>
                    <?php foreach ($req as $k): ?>
                      <tr>
                        <td><?php echo htmlentities($k->author); ?></td>
                        <td><?php echo htmlentities($k->lot);?></td>
                        <td><?php echo htmlentities($k->nb_doc);?></td>
                        <td><?php echo htmlentities($k->hostname);?></td>
